local uiLoader = loadstring(game:HttpGet('https://raw.githubusercontent.com/hubhubasdfewsadwscvg21324rv/roblox/main/aes.lua'))

local ui = uiLoader({rounding = true, theme = 'blueberry',smoothDragging = false })
ui.autoDisableToggles = true

local window = ui.newWindow({text = 'Awu.#0001 - Anime Evolution Simulator',resize = true,size = Vector2.new(550, 376),position = nil})
